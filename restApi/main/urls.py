...
urlpatterns = [
    ...
    path('processos/buscar/',views.BuscarProcessoCampoView.as_view(), name='buscarProcessoCamposView'),
    ...
    path('advogadosOnline/', views.AdvogadosOnlineView.as_view(), name='advogadosOnline'),
    ...
    path('tarefas/buscar/',views.BuscarTarefaCampo.as_view(), name='buscarTarefaCamposView'),   
