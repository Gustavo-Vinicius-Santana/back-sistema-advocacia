...
class Cliente(models.Model):
    ...
    representante = models.ForeignKey('Representante', on_delete=models.SET_NULL, null=True, blank=True, related_name='clientes')
...
class Representante(models.Model):
    ...
    cliente_id = models.ForeignKey(Cliente, on_delete=models.CASCADE, null=True, blank=True, related_name='representante')
